  ...
  <div class="c-main_item_card">
    <div class="c-main_item_cover -red">
      ...
      <div class="c-main_item_details">
        ...
        <p
          class="c-main_item_text"
        >Some amazing content full of interesting things and cool text that will deeply affect your life.</p>
    ...
    <h2 class="c-main_item_title" title="Sample">Sample</h2>
  </div>
</template>